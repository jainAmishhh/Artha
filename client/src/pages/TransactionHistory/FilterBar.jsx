...
//               onClick={() => setFilters({ ...filters, range })}
//               className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all ${
//                 filters.range === range ? "bg-cyan-500 text-white shadow-lg" : "bg-slate-100 text-slate-700"
//               }`}
//             >
//               {range}
//             </button>
...
//         <button
//           onClick={() => { setShowFilters(!showFilters); onFilter(); }}
//           className="flex items-center gap-2 px-6 py-3 bg-slate-100 rounded-xl font-semibold hover:bg-slate-200 transition-all"
//         >
