...
//       <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-lg hover:shadow-xl transition-shadow">
//         <div className="flex items-center gap-3 mb-3">
//           <div className="p-2 bg-rose-100 rounded-xl"><TrendingDown className="text-rose-600" size={20} /></div>
//           <p className="text-sm font-medium text-slate-600">Total Expenses</p>
//         </div>
...
//       <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-lg hover:shadow-xl transition-shadow">
//         <div className="flex items-center gap-3 mb-3">
//           <div className="p-2 bg-cyan-100 rounded-xl"><Wallet className="text-cyan-600" size={20} /></div>
//           <p className="text-sm font-medium text-slate-600">Net Balance</p>
//         </div>
...
//       <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-lg hover:shadow-xl transition-shadow">
//         <div className="flex items-center gap-3 mb-3">
//           <div className="p-2 bg-blue-100 rounded-xl"><Receipt className="text-blue-600" size={20} /></div>
//           <p className="text-sm font-medium text-slate-600">Transactions</p>
//         </div>
